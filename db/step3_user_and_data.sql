-- STEP 3: Create Demo User and Seed Data
-- Run this AFTER step2_rls.sql

-- Create demo user directly in auth.users
...
SELECT 'STEP 3 COMPLETE: User and data created!' as status,
